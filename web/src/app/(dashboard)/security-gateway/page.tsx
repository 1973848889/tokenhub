...
import { Card, Row, Col, Statistic, Table, Tag, Switch, Badge, Space, Typography } from 'antd';
import { SafetyCertificateOutlined, StopOutlined, WarningOutlined, CheckCircleOutlined, SecurityScanOutlined, ThunderboltOutlined } from '@ant-design/icons';
...
export default function SecurityGatewayPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700 }}>安全网关</h1>
