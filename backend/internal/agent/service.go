...
func (s *Service) seedRegisteredAgents() {
	...
	agents := []*RegisteredAgent{
		...
		{ID: "ra-4", Name: "合规审核Agent", Description: "审核生成内容的合规性，拥有全部权限，可执行eval操作", OwnerUserID: "user-003", OwnerName: "王五", OwnerEmail: "wangwu@example.com", DeptID: "dept-rd", DeptName: "研发部", LinkedKeyIDs: []string{}, RiskLevel: "high", Status: "suspended", SandboxRequired: true, AllowedModels: []string{"deepseek-chat"}, DailyBudget: 100, CreatedAt: now.Add(-7*24*time.Hour), TodayCost: 0, TodayTokens: 0, TodayCalls: 0},
		{ID: "ra-security", Name: "安全巡检Agent", Description: "后台常驻安全巡检Agent，对全部Agent/Skill/MCP工具执行注入扫描、权限审计、合规检查和供应链漏洞扫描", OwnerUserID: "system", OwnerName: "系统", OwnerEmail: "system@tokenhub.local", DeptID: "dept-security", DeptName: "安全部", LinkedKeyIDs: []string{}, RiskLevel: "low", Status: "active", SandboxRequired: false, AllowedModels: []string{}, DailyBudget: 0, CreatedAt: now.Add(-90*24*time.Hour), TodayCost: 0, TodayTokens: 0, TodayCalls: 0},
	}
