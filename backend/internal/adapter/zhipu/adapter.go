...
func (a *Adapter) ProviderName() string                               { return "zhipu" }
func (a *Adapter) ModelName() string                                  { return a.modelName }
func (a *Adapter) Capabilities() adapter.Capabilities                 { return adapter.Capabilities{SupportsStreaming: true, SupportsVision: true, SupportsToolCalling: true, MaxContextTokens: 131072, MaxOutputTokens: 8192} }
